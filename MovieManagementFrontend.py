...
st.title("Yash Movie Management")
st.subheader("This project uses Streamlit(Frontend) and MySQL(Database)")
...
def mnu():
    ...
    st.write("4. Cancel ticket")
    st.write("0. Exit\n")
    ch = st.radio("Choose an option:", ["1", "2", "3","4","0"])
    if ch == '1':
        sup()
    elif ch == '2':
        frt()
